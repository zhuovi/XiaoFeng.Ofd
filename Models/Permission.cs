...
namespace XiaoFeng.Ofd.Models
{
    ...
    public class Permission
    {
        ...
        /// 是否允许编辑
        /// </summary>
        public Boolean Edit { get; set; } = true;
        /// <summary>
        /// 是否允许添加或修改标注
        /// </summary>
        public Boolean Annot { get; set; } = true;
        /// <summary>
        /// 是不允许导出
        /// </summary>
        ...
        /// 是否允许进行数字签名
        /// </summary>
        public Boolean Signature { get; set; } = true;
        /// <summary>
        /// 是否允许添加水印
        /// </summary>
        public Boolean Watermark { get; set; } = true;
        /// <summary>
        /// 是否允许截屏
        /// </summary>
        public Boolean PrintScreen { get; set; } = true;
        /// <summary>
